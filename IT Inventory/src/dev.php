...
if ($_SERVER['REQUEST_METHOD'] === 'GET')
{
   ...
   $ip_list = $pdo->query("SELECT * FROM ip ORDER BY IPv4")->fetchAll();
   ...
   echo "<tr><td><label>{$cfgLang['Name']}</label></td><td><input type='text' name='name' value='". ($newDevice ? "'" : htmlspecialchars($device['name'])."' required")."></td></tr>";
   echo "<tr><td><label>{$cfgLang['Device']}</label></td><td><input type='text' name='device' value='". ($newDevice ? "'" : htmlspecialchars($device['device']))."'></td></tr>";
   echo "<tr><td><label>{$cfgLang['Manufacturer']}</label></td><td><input type='text' name='manufacturer' value='". ($newDevice ? "'" : htmlspecialchars($device['manufacturer']))."'></td></tr>";
   echo "<tr><td><label>{$cfgLang['Model']}</label></td><td><input type='text' name='model' value='". ($newDevice ? "'" : htmlspecialchars($device['model']))."'></td></tr>";
   
   // Category
   echo "<tr><td><label>{$cfgLang['Category']}</label></td><td>";
   ...
   echo "<tr><td><label>{$cfgLang['Inventory']}</label></td><td><input type='text' name='inventory' value='". ($newDevice ? "'" : htmlspecialchars($device['inventory']))."'></td></tr>";
   
   // IP Address 1
   echo "<tr><td><label>{$cfgLang['IP1']}</label></td><td>";
   ...
   // IP is active
   echo "<tr><td><label>{$cfgLang['IPActive']}</label></td><td><input type='hidden' name='ip_isactive' value='0'>";
   if ($newDevice === true)
   {
   ...
   // IP Address 2
   echo "<tr><td><label>{$cfgLang['IP2']}</label></td><td>";
   ...
   echo "<tr><td><label>{$cfgLang['Firmware']}</label></td><td><input type='text' name='firmware' value='". ($newDevice ? "'" : htmlspecialchars($device['firmware']))."'></td></tr>";
   echo "<tr><td><label>{$cfgLang['Custodian']}</label></td><td><input type='text' name='custodian' value='". ($newDevice ? "'" : htmlspecialchars($device['custodian']))."'></td></tr>";
   
   // Location 1
      echo "<tr><td><label>{$cfgLang['Location1']}</label></td><td>";
   ...
   echo "<tr><td><label>{$cfgLang['Location2']}</label></td><td><input type='text' name='location2' value='". ($newDevice ? "'" : htmlspecialchars($device['location2']))."'></td></tr>";

   // Status
   echo "<tr><td><label>{$cfgLang['Status']}</label></td><td>";
